        ...
        public Dictionary<String, String> FindPage(int id)
        {
            ...
            try
            {
                ...
                while (resultset.Read())
                {
                    ...
                    Dictionary<String, String> Page_page = new Dictionary<String, String>();
                    ...
                    for (int i = 0; i < resultset.FieldCount; i++)
                    {
                        ...
                        Page_page.Add(resultset.GetName(i), resultset.GetString(i));
                ...
                page = Pages[0]; //get the first student
